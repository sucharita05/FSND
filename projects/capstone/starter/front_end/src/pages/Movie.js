        ...
        <div>
			...
			<header>
				<div className="container">
					...
					<section className="hero-wrap" style={{backgroundImage: 'url(assets/images/mv-5.jpg)'}}>
				...
				<div className="container">
					...
					<div className="col-md-8 ftco-animate text-center">
						<p className="breadcrumbs"><span className="mr-2"><a href="index.html">Home</a></span> <span>Movies</span></p>
					</div>
					</div>
				</div>
			</section>
		...
		<section className="ftco-section">
			<div className="container">
			  ...
			  <div className="row d-flex">
				<div className="col-md-4 d-flex ftco-animate">
					<div className="blog-entry bg-dark align-self-stretch">
					<a href="blog-single.html" className="block-20" style={{backgroundImage: 'url(assets/images/mv-3.jpg)'}}>
					</a>
					<div className="text p-4 d-block">
						<div className="meta mb-3">
					  </div>
					  <h3 className="heading mt-3"><a href="#">Toofan</a></h3>
					  <p>Release Date: 21 May 2021 </p>
					  <p><a href="https://in.bookmyshow.com" className="btn btn-primary">Book Tickets</a></p>
					</div>
				  </div>
				</div>
				<div className="col-md-4 d-flex ftco-animate">
					<div className="blog-entry bg-dark align-self-stretch">
					<a href="blog-single.html" className="block-20" style={{backgroundImage: 'url(assets/images/mv-4.jpg)'}}>
					</a>
					<div className="text p-4 d-block">
						<div className="meta mb-3">
						</div>
					  <h3 className="heading mt-3"><a href="#">The Conjuring 3: The Devil Made Me Do It</a></h3>
					  <p>Release Date: 4 June 2021 </p>
					  <p><a href="https://in.bookmyshow.com" className="btn btn-primary">Book Tickets</a></p>
					</div>
				  </div>
				</div>
