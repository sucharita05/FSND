				...
				<div className="page">
					<nav id="colorlib-main-nav" role="navigation">
						...
						<div className="js-fullheight colorlib-table">
							<div className="img" style={{ backgroundImage: 'url(assets/images/img-6.jfif)' }}></div>
								...
								<div className="row no-gutters">
									<div className="col-md-12 text-center">
										...
										<ul>
											...
											<li className="active"><a href="/about"><span>About</span></a></li>
					...
					<div id="colorlib-page">
						...
						<section className="hero-wrap" style={{ backgroundImage: 'url(assets/images/img-6.jpg)' }}>
							...
							<div className="container">
								<div className="row no-gutters text align-items-end justify-content-center" data-scrollax-parent="true">
									<div className="col-md-8 ftco-animate text-center">
										...
										<h1 className="mb-5 bread">About Us</h1>
									</div>
								</div>
							</div>
						</section>
